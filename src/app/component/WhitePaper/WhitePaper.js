  ...
  return (
        <div className={styles.whitepaper}>
            <h2>Livre Blanc du Projet ChainToken</h2>
                <p>Ce livre blanc présente une vue d'ensemble du Projet ChainToken, détaillant notre vision, notre architecture blockchain et les cas d'utilisation de notre token. Les points clés incluent :</p>
                <ul>
