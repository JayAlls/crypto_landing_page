...
const WhitePaper = () => {
  return (
        <div className={styles.whitepaper}>
            ...
            <p>
                Ce livre blanc présente une vue d'ensemble du Projet XYZ, détaillant notre vision, notre architecture blockchain et les cas d'utilisation de notre token. Les points clés incluent :
                <ul>
                    <li>La problématique que le Projet XYZ vise à résoudre.</li>
